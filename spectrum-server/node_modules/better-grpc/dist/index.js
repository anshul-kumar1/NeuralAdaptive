...
// src/utils/proto-loader.ts
var import_grpc_js = __toESM(require_src3());
var import_proto_loader = __toESM(require_src2());
...
var GrpcClient = class {
  ...
  start() {
    for (const serviceImpl of this.serviceImpls) {
      const client2 = this.clientFactory.create(
        this.proto[serviceImpl.serviceClass.serviceName].service,
        this.channel
      );
  ...
  async waitUntilReady(timeoutMs = 5e3) {
